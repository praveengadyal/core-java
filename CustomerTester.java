...
System.out.println("provide the order personName with which you want to update.....");
String personName1=sc.next();
System.out.println("enter the updated Address");
String address1=sc.next();
c.updateAddressByPersonName(personName1,address1);
...
System.out.println("provide the Order Id with which you want to update....");
int id1=sc.nextInt();
System.out.println("enter the updated price");
int price1=sc.nextInt();
c.updateOrderPriceById(id1,price1);
...
System.out.println("enter the personName with which you want to delete......");
String personName=sc.next();
c.deleteOrderByPersonName(personName);
c.getOrderDetails();

System.out.println("enter the noOfItems with which you want delete....");
int noOfItems=sc.nextInt();
c.deleteOrderByNoOfItems(noOfItems);
c.getOrderDetails();
*/
