...
System.out.println("provide the id with which you want to update.....");
int id1=sc.nextInt();
System.out.println("enter the updated price...");
int price1=sc.nextInt();
h.updateFoodItemsPriceById(id1,price1);
...
System.out.println("provide the name with which you want to update.....");
String name1=sc.next();
System.out.println("enter the updated type....");
String type1=sc.next();
h.updateFoodItemTypeByName(name1,type1);
...
System.out.println("enter the FoodItemId with which you want to delete object");
int id=sc.nextInt();
h.deleteFoodItemById(id);
h.getFoodItemsDetails();

System.out.println("enter the FoodItemName with which you want to delete object");
String name=sc.next();
h.deleteFoodItemByName(name);
h.getFoodItemsDetails();
*/
